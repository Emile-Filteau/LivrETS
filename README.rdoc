== README {<img src="https://magnum.travis-ci.com/Emile-Filteau/LivrETS.svg?token=zCUA4tsbJSGJyL6iJmqr&branch=master" alt="Build Status" />}[https://magnum.travis-ci.com/Emile-Filteau/LivrETS]
...
1. Make sure every environnement variables are set in heroku +heroku config+
